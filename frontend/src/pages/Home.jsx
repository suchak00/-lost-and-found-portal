...
export default function Home() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        // Not logged in - that's fine for the homepage
        setUser(null)
      } finally {
        setLoading(false)
      }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8f9fc] to-white text-gray-900">
      {/* Navbar */}
      <nav className="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-200 px-8 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <div className="flex gap-1">
              <span className="font-bold text-lg text-gray-800">Find</span>
          ...
          <div className="flex items-center gap-8">
            <a href="#" className="text-sm font-medium text-gray-900 hover:text-purple-600 transition">Home</a>
            <button onClick={() => navigate('/my-reports')} className="text-sm font-medium text-gray-600 hover:text-gray-900 transition">My Reports</button>
            <button onClick={() => navigate('/report-lost')} className="text-sm font-medium text-gray-600 hover:text-gray-900 transition">Report Lost</button>
            <button onClick={() => navigate('/report-found')} className="text-sm font-medium text-gray-600 hover:text-gray-900 transition">Report Found</button>
          </div>

          {/* Right side */}
          <div className="flex items-center gap-4">
            {/* Search */}
            <div className="hidden md:flex items-center bg-gray-100 rounded-lg px-3 py-2 border border-gray-300">
              <input
                type="text"
                placeholder="Search..."
                className="bg-transparent text-sm outline-none text-gray-900 placeholder-gray-600 w-32"
              />
            </div>
      ...
      <section className="relative max-w-6xl mx-auto px-4 py-20 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full border border-purple-300 bg-purple-50">
          <svg className="w-4 h-4 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
          </svg>
          <span className="text-xs font-medium text-gray-700">Campus Lost & Found Portal</span>
          <svg className="w-4 h-4 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-4 leading-tight">
          ...
          <span className="block bg-gradient-to-r from-purple-600 via-blue-500 to-purple-600 bg-clip-text text-transparent">
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-24 left-0 right-0 h-1 bg-gradient-to-r from-purple-300 via-blue-300 to-transparent"></div>

          {/* Step 1 */}
          <div className="relative">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-purple-300 bg-purple-50 mb-6 mx-auto">
                <svg className="w-8 h-8 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" />
                </svg>
              </div>
              <div className="inline-block px-3 py-1 rounded-full bg-purple-100 border border-purple-300 text-xs font-medium text-purple-700 mb-4">
                Step 1
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Report Item</h3>
              <p className="text-gray-600 text-sm">Fill out a detailed report form with photos and item details</p>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-blue-300 bg-blue-50 mb-6 mx-auto">
                <svg className="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
                </svg>
              </div>
              <div className="inline-block px-3 py-1 rounded-full bg-blue-100 border border-blue-300 text-xs font-medium text-blue-700 mb-4">
                Step 2
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Search & Match</h3>
              <p className="text-gray-600 text-sm">Browse existing reports or get auto-matched with found items</p>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-indigo-300 bg-indigo-50 mb-6 mx-auto">
                <svg className="w-8 h-8 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5z" />
                </svg>
              </div>
              <div className="inline-block px-3 py-1 rounded-full bg-indigo-100 border border-indigo-300 text-xs font-medium text-indigo-700 mb-4">
                Step 3
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">Connect Safely</h3>
              <p className="text-gray-600 text-sm">Secure messaging between finder and owner for coordination</p>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border-2 border-teal-300 bg-teal-50 mb-6 mx-auto">
